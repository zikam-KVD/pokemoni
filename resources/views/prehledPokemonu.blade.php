        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <table>
                    ...
                    @foreach ($vysledkyzDB as $pokemon)
                    <tr>
                        <td>{{ $pokemon->jmeno }}</td>
                        <td>{{ $pokemon->mazlivost }}</td>
                        <td>{{ $pokemon->velikost }}</td>
                        <td>{{ $pokemon->typ }}</td>
                        <td>
                            <form method="POST" action="{{ route('pokemon-smazat', ['id' => $pokemon->id]) }}">
                                @csrf
                        ...
                        <form method="POST" action="{{ route('pokemon-pridat') }}">
                            ...
                            <td>
                                <select name="typ">
                                    ...
                                    <option value="travní">travní</option>
                                    <option value="bojový">bojový</option>
                                </select>
                            </td>
                            <td>
